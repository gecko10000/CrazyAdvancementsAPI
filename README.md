...
Check [build.gradle.kts](build.gradle.kts#L12) for the version to use. It will always align with the Minecraft version,
and have an extra number at the end to show the revision for that version.
